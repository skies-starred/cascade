        ...
        *///? } else {
        ...
        private val PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.GUI_SNIPPET)
                ...
                .withVertexShader(Identifier.fromNamespaceAndPath("cascade", "core/shapes/arc/arc"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("cascade", "core/shapes/arc/arc"))
                .build()
        )
