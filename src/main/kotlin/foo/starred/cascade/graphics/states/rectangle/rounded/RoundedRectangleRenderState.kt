package foo.starred.cascade.states.impl.rectangle.rounded
...
class RoundedRectangleRenderState(
    ...
    override fun buildVertices(vertexConsumer: VertexConsumer) {
        ...
        fun vertex(x: Float, y: Float, u: Float, v: Float) {
            vertexConsumer.addVertexWith2DPose(pose, x, y).setColor(color).setUv(u, v).setUv1(width, height).setUv2(u2x, u2y).setNormal(line0, 0f, line)
        }
