    ...
    companion object {
        private val PIPELINE_MSDF: RenderPipeline = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
                ...
                .withFragmentShader(Identifier.fromNamespaceAndPath("cascade", "core/font/msdf/msdf"))
                .build()
        )
        ...
        private val PIPELINE_SDF: RenderPipeline = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
                ...
                .withFragmentShader(Identifier.fromNamespaceAndPath("cascade", "core/font/sdf/sdf"))
                .build()
        )
    }
}
