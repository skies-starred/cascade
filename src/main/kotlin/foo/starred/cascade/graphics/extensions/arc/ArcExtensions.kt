...
@JvmOverloads
fun GuiGraphicsExtractor.arc(x: Float, y: Float, radius0: Float, radius1: Float, angle0: Float, angle1: Float, rounded: Boolean, color: CascadeGeometricColor = CascadeGeometricColor.WHITE, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
...
fun GuiGraphicsExtractor.arc(x: Float, y: Float, radius0: Float, radius1: Float, angle0: Float, angle1: Float, rounded: Boolean, color: Int, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
    arc(x, y, radius0, radius1, angle0, angle1, rounded, CascadeGeometricColor(color), pose, scissor)
}

@JvmOverloads
fun GuiGraphicsExtractor.ring(x: Float, y: Float, radius0: Float, radius1: Float, color: CascadeGeometricColor = CascadeGeometricColor.WHITE, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
...
fun GuiGraphicsExtractor.ring(x: Float, y: Float, radius0: Float, radius1: Float, color: Int, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
    ring(x, y, radius0, radius1, CascadeGeometricColor(color), pose, scissor)
}
