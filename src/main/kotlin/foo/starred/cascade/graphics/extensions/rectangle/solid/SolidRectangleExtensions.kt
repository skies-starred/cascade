...
fun GuiGraphicsExtractor.rectangle(x: Float, y: Float, width: Float, height: Float, color: CascadeGeometricColor = CascadeGeometricColor.WHITE, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
...
fun GuiGraphicsExtractor.rectangle(x: Float, y: Float, width: Float, height: Float, color: Int = -1, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
    rectangle(x, y, width, height, CascadeGeometricColor(color), pose, scissor)
}
