...
fun GuiGraphicsExtractor.dropShadow(x: Float, y: Float, width: Float, height: Float, offset: CascadeGeometricOffset, blur: Float, spread: Float, color: CascadeGeometricColor = CascadeGeometricColor.BLACK, radius: CascadeGeometricRadius, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null, bounds: ScreenRectangle? = null) {
...
fun GuiGraphicsExtractor.dropShadow(x: Float, y: Float, width: Float, height: Float, offset: CascadeGeometricOffset, blur: Float, spread: Float, color: Int, radius: CascadeGeometricRadius, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null, bounds: ScreenRectangle? = null) {
    dropShadow(x, y, width, height, offset, blur, spread, CascadeGeometricColor(color), radius, pose, scissor, bounds)
}
