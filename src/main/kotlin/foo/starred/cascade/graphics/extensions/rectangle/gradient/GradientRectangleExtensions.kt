...
fun GuiGraphicsExtractor.gradientRectangle(x: Float, y: Float, width: Float, height: Float, color: CascadeGeometricColor, pose: Matrix3x2f? = null, scissor: ScreenRectangle? = null) {
