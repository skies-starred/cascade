...
class TexturedRectangleRenderState(
    ...
    override fun buildVertices(vertexConsumer: VertexConsumer) {
        vertexConsumer.addVertexWith2DPose(pose, x0, y0).setColor(col1).setUv(u0, v0)
        vertexConsumer.addVertexWith2DPose(pose, x0, y1).setColor(col2).setUv(u0, v1)
        vertexConsumer.addVertexWith2DPose(pose, x1, y1).setColor(col2).setUv(u1, v1)
        vertexConsumer.addVertexWith2DPose(pose, x1, y0).setColor(col1).setUv(u1, v0)
    }
